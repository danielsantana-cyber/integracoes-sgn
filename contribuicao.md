...
O modelo completo está em [Modelo de Novo Caso](docs/modelo-de-registro.md).
...
|---|---|
| API, WSO2, serviço, integração, sincronização | [Integrações](docs/integracoes.md) |
| ERP, faturamento, cadastro, cobrança, documento | [Benner](docs/benner.md) |
| Permissões, acessos, onboarding, primeiros passos | [Acessos e Primeiros Passos](docs/acessos.md) |
| Painéis, leitura de dados, validação de indicadores | [Dashboard](docs/dashboard.md) |
| Caso reincidente ou padrão que vale consolidar | [Problemas Recorrentes](docs/problemas.md) |
